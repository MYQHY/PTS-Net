...
<p align="left">
  <img src="fig/pipeline.png" alt="Pipelne">
</p>
...
- **2026-06-18**: 🚀 All code has been released.
...
The dataset generated by MATLAB should follow this structure:
...
```bash
python train.py --data_root "F:\PTSoutput" --save_dir ".\pts_final" --train_txt "F:\EWIRSTD\train.txt" --val_txt "F:\EWIRSTD\val.txt" --epochs 60 --batch_size 4 --lr 3e-4 --lr_step_size 20 --lr_gamma 0.5 --img_size 0 --num_workers 0 --base_ch 32 --aux_scale 0.5 --threshold_latest 0.5 --threshold_traj 0.5 --grad_clip 1.0 --seed 42 --pd_radius 1 --fa_radius 4
```

### Test

```bash
python infer.py --data_root "F:\PTSoutput" --ckpt ".\pts_final\best.pt" --save_dir "F:\EWIRSTD\pts_final" --test_txt "F:\EWIRSTD\test.txt" --img_size 0 --batch_size 1 --num_workers 0 --base_ch 32 --aux_scale 0.5 --threshold_latest 0.5 --threshold_traj 0.5 --save_prob_png 1 --save_prob_npy 1 --warmup_iters 5
```
